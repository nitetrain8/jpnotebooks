...
def mk_struct(ob):
    if isinstance(ob, list):
        return [mk_struct(o) for o in ob]
    fields = []
    for k, v in ob.items():
...
class Fight():
    ...
    def events(self, fs, **other):
        ...
        while True:
            ...
            if start is None or start > self.end_time:
                break
        return rv
...
class Fights():
    def __init__(self, api, d=None, report_id=None):
        ...
        if d is not None:
            ...
            if 'friendlies' in d: lff.extend(d['friendlies'])
            if 'friendlyPets' in d: lff.extend(d['friendlyPets'])
            self.friendlies = Friendlies(api, lff)
            
            lfe = []  # list for enemies
            if 'enemies' in d: lfe.extend(d['enemies'])
            if 'enemyPets' in d: lfe.extend(d['enemyPets'])
...
# These are the spec IDs returned in 
# 'combatantinfo' events at the start of a fight 
# which tell which class/spec a given player is
# as far as i know, these can't be retrieved
# directly from an api call. The call that
# should return them, /classes, returns ids
# of 1,2,3 for every class 

# These can best be verified or generated by parsing
# a large number of generic reports until all 36 
# unique specIDs have been identified, then using
# the spellID of one of the artifact abilities 
# to manually determine the class/weapon the 
# ability belongs to. 

# Potentially, one way to dynamically generate this list is to
# generate a list of known artifact ability IDs and parse the list
# on start up to crossreference, but that type of solution
# imposes significant overhead (up to minutes(?)), so we
# just have to hope that the ID list never changes. 
...
sl[65] = "Paladin", "Holy"
sl[66] = "Paladin", "Protection"
sl[70] = "Paladin", "Retribution"

sl[71] = "Warrior", "Arms"
sl[72] = "Warrior", "Fury"
sl[73] = "Warrior", "Protection"

sl[102] = "Druid", "Balance"
sl[103] = "Druid", "Feral" 
sl[104] = "Druid", "Guardian"
sl[105] = "Druid", "Restoration"

sl[250] = "DeathKnight", "Blood"
sl[251] = "DeathKnight", "Frost"
sl[252] = "DeathKnight", "Unholy"

sl[253] = "Hunter", "Beast Mastery"
sl[254] = "Hunter", "Marksmanship"
sl[255] = "Hunter", "Survival"

sl[256] = "Priest", "Discipline"
sl[257] = "Priest", "Holy"
sl[258] = "Priest", "Shadow"

sl[259] = "Rogue", "Assassination"
sl[260] = "Rogue", "Outlaw"
sl[261] = "Rogue", "Subtlety"

sl[262] = "Shaman", "Elemental"
sl[263] = "Shaman", "Enhancement"
sl[264] = "Shaman", "Restoration"

sl[265] = "Warlock", "Affliction"
sl[266] = "Warlock", "Demonology"
sl[267] = "Warlock", "Destruction"

sl[268] = "Monk", "Brewmaster"
sl[269] = "Monk", "Windwalker"
sl[270] = "Monk", "Mistweaver"

sl[577] = "DemonHunter", "Havoc"
sl[581] = "DemonHunter", "Vengeance"
del sl